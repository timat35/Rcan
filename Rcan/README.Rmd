...
Rcan functions are design at the Cancer Surveillance Unit at International Agency  for Research on Cancer. The goal is to provide tools for scientist and other fellows using cancer epidemiological data. 
