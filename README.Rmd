...
Rcan functions are design at [the Cancer Surveillance Unit at International Agency for Research on Cancer](https://www.iarc.fr/en/research-groups/sec1/index.php). The goal is to provide tools for scientist and other fellows using cancer epidemiological data. 
